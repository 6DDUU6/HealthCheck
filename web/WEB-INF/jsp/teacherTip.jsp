    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-left">
                <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/jumpTeacherMain">学生打卡记录</a>
                </li>
                <li class="layui-nav-item layui-this">发布打卡</li>
            </ul>
    ...
    layui.use(['jquery','table'], function () {
        ...
        table.on('toolbar(test)', function (obj) {
            ...
            switch (obj.event) {
                case 'addData':
                    $.ajax({
                        url: '${pageContext.request.contextPath}/addSignTip',
                        dataType: 'json',
                        async:false,
